...
export const preloadTextures = function(callback) {
  ...
  const texturePaths = [
    ...
    "./textures/double-health-0.png",
    "./textures/double-health-1.png",
    "./textures/double-health-2.png",
    "./textures/double-health-3.png",
    "./textures/double-health-4.png",
    "./textures/double-health-5.png",
    "./textures/double-health-6.png",
    "./textures/double-health-7.png",
    "./textures/double-health-8.png",
    "./textures/double-health-9.png",
